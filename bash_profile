...
export PATH="$JAVA_HOME:$CURL_HOME:/opt/homebrew/bin:/opt/homebrew/sbin:$PATH:$M2_HOME/bin:$HOME/.krew/bin:$PYTHON_BIN:/opt/homebrew/Cellar/openssl\@1.1/1.1.1s/bin/"
...
unset JAVA_HOME
unset JDK_HOME
source '/opt/homebrew/Cellar/jenv/0.5.5_2/libexec/libexec/../completions/jenv.bash'
